...
The app will start locally at **[http://localhost:5173](http://localhost:5173)**.
You can now interact with the visualizer in real-time and tweak animations or algorithms.
